...
public class CursorController : MonoBehaviour {
    ...
    [SerializeField] private GameObject titleController;
    RectTransform rectTransform;

    void Start() {
        rectTransform = GetComponent<RectTransform>();

        titleController.GetComponent<FadeController>().FadeIn();
    }
    ...
    void Select() {
        ...
        switch (select) {
            case 0:
                titleController.GetComponent<FadeController>().FadeOut("StageSelect");
                break;
            case 1:
